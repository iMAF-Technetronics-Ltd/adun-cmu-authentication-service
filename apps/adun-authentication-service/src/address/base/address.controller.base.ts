...
import { SocietyFindManyArgs } from "../../society/base/SocietyFindManyArgs";
import { Society } from "../../society/base/Society";
...
export class AddressControllerBase {
  ...
  async findManySocieties(
    @common.Req() request: Request,
    @common.Param() params: AddressWhereUniqueInput
  ): Promise<Society[]> {
    const query = plainToClass(SocietyFindManyArgs, request.query);
    const results = await this.service.findSocieties(params.id, {
      ...query,
      select: {
        address: {
          select: {
  ...
  @common.Post("/:id/societies")
  @nestAccessControl.UseRoles({
    resource: "Address",
    action: "update",
    possession: "any",
  })
  async connectSocieties(
    @common.Param() params: AddressWhereUniqueInput,
    @common.Body() body: SocietyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      societies: {
        connect: body,
  ...
  @common.Delete("/:id/societies")
  @nestAccessControl.UseRoles({
    resource: "Address",
    action: "update",
    possession: "any",
  })
  async disconnectSocieties(
    @common.Param() params: AddressWhereUniqueInput,
    @common.Body() body: SocietyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
